...
C {devices/lab_pin.sym} -37.5 20 0 0 {name=l3 lab=VDD}
...
C {devices/lab_pin.sym} 150 -40 0 0 {name=l10 lab=VOUT}
C {devices/lab_pin.sym} 150 20 0 0 {name=l11 lab=GND}
C {devices/gnd.sym} -400 0 0 0 {name=l12 lab=GND}
...
wrdata nand2_tran.csv v(VIN) v(VOUT)
.endc
"}
